...
# -------- CARGA --------
input_csv_path = os.path.join(os.path.expanduser("~"), "Downloads", "ultimatum_tratamiento_2_2025-04-15.csv")
...
# -------- EXPORTACIÓN --------
output_name = "data_dictador_tratamiento_2.csv"
downloads_path = os.path.join(os.path.expanduser("~"), "Downloads", output_name)
desktop_path = os.path.join(os.path.expanduser("~"), "OneDrive", "Desktop", "Scripts tratamiento 2", output_name)
