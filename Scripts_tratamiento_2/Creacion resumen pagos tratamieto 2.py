...
# -------- CONFIGURACIÓN --------
file_path = r"C:\Users\lucia\Downloads\ultimatum_tratamiento_2_2025-04-15.csv".replace("\\", "/")

downloads = os.path.join(os.path.expanduser("~"), "Downloads")
desktop_folder = os.path.join(os.path.expanduser("~"), "OneDrive", "Desktop", "Scripts tratamiento 2")
os.makedirs(desktop_folder, exist_ok=True)

output_excel = os.path.join(downloads, "resumen_pagos_tratamiento_2.xlsx")
desktop_output_excel = os.path.join(desktop_folder, "resumen_pagos_tratamiento_2.xlsx")
pdf_path_downloads = os.path.join(downloads, "resumen_pagos_tratamiento_2.pdf")
pdf_path_desktop = os.path.join(desktop_folder, "resumen_pagos_tratamiento_2.pdf")
...
pdf.cell(0, 10, "Resumen de Pagos - Tratamiento 2", ln=True, align='C')
pdf.ln(10)
