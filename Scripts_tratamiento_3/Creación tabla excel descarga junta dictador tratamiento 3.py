...
input_csv_path = os.path.join(os.path.expanduser("~"), "Downloads", "ultimatum_tratamiento_3_2025-04-15.csv")
...
# Rutas de salida
output_name = "data_dictador_tratamiento_3.csv"
downloads_path = os.path.join(os.path.expanduser("~"), "Downloads", output_name)
desktop_path = os.path.join(os.path.expanduser("~"), "OneDrive", "Desktop", "Scripts tratamiento 3", output_name)
