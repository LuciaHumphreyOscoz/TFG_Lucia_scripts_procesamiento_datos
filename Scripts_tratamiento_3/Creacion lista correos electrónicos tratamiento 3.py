...
ruta_csv = r"C:\Users\lucia\Downloads\emails_2025-04-13.csv".replace("\\", "/")

# Carpeta de destino y nombre del archivo .txt
carpeta_destino = r"C:\Users\lucia\OneDrive\Desktop\Scripts tratamiento 3".replace("\\", "/")
...
df_filtrado = df[df["session.label"] == "Correos tratamiento 3"]
