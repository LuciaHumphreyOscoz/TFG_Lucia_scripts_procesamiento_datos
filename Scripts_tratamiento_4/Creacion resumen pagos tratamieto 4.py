...
# -------- CONFIGURACIÓN --------
file_path = r"C:\Users\lucia\Downloads\ultimatum_tratamiento_4_2025-04-15.csv".replace("\\", "/")

downloads = os.path.join(os.path.expanduser("~"), "Downloads")
desktop_folder = os.path.join(os.path.expanduser("~"), "OneDrive", "Desktop", "Scripts tratamiento 4")
os.makedirs(desktop_folder, exist_ok=True)

output_excel = os.path.join(downloads, "resumen_pagos_tratamiento_4.xlsx")
desktop_output_excel = os.path.join(desktop_folder, "resumen_pagos_tratamiento_4.xlsx")
pdf_path_downloads = os.path.join(downloads, "resumen_pagos_tratamiento_4.pdf")
pdf_path_desktop = os.path.join(desktop_folder, "resumen_pagos_tratamiento_4.pdf")
...
pdf.cell(0, 10, "Resumen de Pagos - Tratamiento 4", ln=True, align='C')
pdf.ln(10)
