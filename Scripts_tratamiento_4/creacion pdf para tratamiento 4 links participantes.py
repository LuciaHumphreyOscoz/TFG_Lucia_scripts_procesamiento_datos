...
winner_links = [
    'https://game-experiments-d8f8ab596e55.herokuapp.com/InitializeParticipant/nesu1yre',  # P1
    'https://game-experiments-d8f8ab596e55.herokuapp.com/InitializeParticipant/76c12v7f',  # P3
    'https://game-experiments-d8f8ab596e55.herokuapp.com/InitializeParticipant/aiurgel8',  # P5
]

loser_links = [
    'https://game-experiments-d8f8ab596e55.herokuapp.com/InitializeParticipant/saulz9w7',  # P2
    'https://game-experiments-d8f8ab596e55.herokuapp.com/InitializeParticipant/upwhvbvh',  # P4
    'https://game-experiments-d8f8ab596e55.herokuapp.com/InitializeParticipant/ct4fwvww',  # P6
]
...
pdf_path = os.path.join(downloads_path, "participant_links_tratamiento_4.pdf")
pdf.output(pdf_path)
...
desktop_pdf_path = os.path.join(desktop_folder, "participant_links_tratamiento_4.pdf")
